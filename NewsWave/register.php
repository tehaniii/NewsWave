...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO registration_requests (firstName, lastName, gender, email, employeeID, role, nic, dob, contact, address, username, password) 
        VALUES ('$firstName', '$lastName', '$gender', '$email', '$employeeID', '$role', '$nic', '$dob', '$contact', '$address', '$username', '$password')";
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
        <div class="form-group">
            ...
            <select name="role" id="role">
                ...
                <option value="employee">IT Staff</option>
