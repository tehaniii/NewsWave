...
// Fetch employee data from the database using session username
if (isset($_SESSION['username'])) {
    ...
    if ($user) {
        // Fetch uploaded news articles by the current employee based on author_contact
        ...
        die("No employee found with the given username.");
    }
} else {
